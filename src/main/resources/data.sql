...
-- (1, 1, 4.5, true, ST_GeomFromText('POINT(73.9282 18.5085)', 4326)), -- Hadapsar
-- (2, 2, 4.2, true, ST_GeomFromText('POINT(73.9795 18.4964)', 4326)), -- Loni Kalbhor
-- (3, 3, 4.8, false, ST_GeomFromText('POINT(73.9257 18.5126)', 4326)), -- Magarpatta
-- (4, 4, 4.1, true, ST_GeomFromText('POINT(73.9567 18.5514)', 4326)), -- Kharadi
-- (5, 5, 3.9, false, ST_GeomFromText('POINT(73.8736 18.5167)', 4326)), -- Camp
-- (6, 6, 4.0, true, ST_GeomFromText('POINT(73.8530 18.5301)', 4326)), -- Shivajinagar
-- (7, 7, 4.7, true, ST_GeomFromText('POINT(73.9274 18.5018)', 4326)), -- Hadapsar
-- (8, 8, 4.3, false, ST_GeomFromText('POINT(73.9257 18.5137)', 4326)), -- Magarpatta
-- (9, 9, 4.4, true, ST_GeomFromText('POINT(73.8736 18.5171)', 4326)), -- Camp
-- (10, 10, 4.6, true, ST_GeomFromText('POINT(73.9565 18.5518)', 4326)); -- Kharadi
